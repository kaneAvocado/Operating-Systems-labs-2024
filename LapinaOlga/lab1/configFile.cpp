...
bool configFile::readConfigFile(const std::string& config_path)
{
	...
	while (getline(config_file, s)) 
	{
		...
		switch (count)
		{
		case 0: folder1 = res_str; break;
		case 1: folder2 = res_str; break;
		case 2: MAX_FILE_AGE_IN_SECONDS = atoi(res_str.c_str()) * 2; break;
		case 3: INTERVAL_IN_SECONDS = atoi(res_str.c_str()); break;
		}
